...
export const getCityInfo = async (latitud: number, longitud: number) => {
  return await axios.get(
    `http://129.28.95.21/api/city/lookup?location=${longitud.toFixed(2)},${latitud.toFixed(2)}`,
  );
};

export const getCityInfoByCityName = async (cityName: string) => {
  return await axios.get(
    `http://129.28.95.21/api/city/lookup?location=${cityName}`,
  );
};
...
export const getWeatherInfo = async (cityId: string) => {
  return await axios.get(
    `http://129.28.95.21/api/weather/now?location=${cityId}`,
  );
};
...
export const get7DayForecast = async (locationId: string) => {
  return await axios.get(
    `http://129.28.95.21/api/weather/7d?location=${locationId}`,
  );
};
...
export const get24HoursForecast = async (locationId: string) => {
  return await axios.get(
    `http://129.28.95.21/api/weather/24h?location=${locationId}`,
  );
};

export const getLifeIndex = async (locationId: string) => {
  return await axios.get(
    `http://129.28.95.21/api/indices/1d?location=${locationId}&type=1,2,3,5`,
  );
};
